...
\usepackage{graphicx}
\usepackage{hyperref}
\usepackage{cite, float, xcolor, highlightx, afterpage}
...
\noindent\fcolorbox{pink}{lightgray}{%
  \begin{minipage}{\dimexpr\linewidth-2\fboxrule-2\fboxsep\relax}
    Anything mentioned within the last lecture as 'ignorable' has
    a background like this
  \end{minipage}}%

% \HighlightText*[bg=green]{hello\\there}
